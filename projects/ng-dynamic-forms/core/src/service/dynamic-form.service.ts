...
import { DynamicPInputModel, DYNAMIC_FORM_CONTROL_TYPE_P } from "../../../custom/dynamicmodels/dynamic-pinput.model";
import { DynamicFileInputModel, DYNAMIC_FORM_CONTROL_TYPE_CUSTOM_FILE } from "../../../custom/dynamicmodels/dynamic-fileinput.model";
        ...
        formModelJSON.forEach((model: any) => {
            ...
            switch (model.type) {
                ...
                case DYNAMIC_FORM_CONTROL_TYPE_TIMEPICKER:
                    ...
                    break;
                case DYNAMIC_FORM_CONTROL_TYPE_P:
                        formModel.push(new DynamicPInputModel(model, layout));
                        break;
    
                case DYNAMIC_FORM_CONTROL_TYPE_CUSTOM_FILE:
                        formModel.push(new DynamicFileInputModel(model, layout));
                        break;
                default:
